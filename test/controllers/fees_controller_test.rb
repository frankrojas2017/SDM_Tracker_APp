...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { fee_type_id: @fee.fee_type_id, price: @fee.price, quote_id: @fee.quote_id } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { fee_type_id: @fee.fee_type_id, price: @fee.price, quote_id: @fee.quote_id } }
