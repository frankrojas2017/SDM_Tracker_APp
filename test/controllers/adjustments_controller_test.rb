...
class AdjustmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adjustment" do
    assert_difference('Adjustment.count') do
      post adjustments_url, params: { adjustment: { price: @adjustment.price, quote_number_id: @adjustment.quote_number_id, reason: @adjustment.reason } }
    end
  ...
  test "should update adjustment" do
    patch adjustment_url(@adjustment), params: { adjustment: { price: @adjustment.price, quote_number_id: @adjustment.quote_number_id, reason: @adjustment.reason } }
