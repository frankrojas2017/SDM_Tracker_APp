...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post agreements_url, params: { agreement: { agreement_type_id: @agreement.agreement_type_id, approved: @agreement.approved, end_date: @agreement.end_date, link: @agreement.link, start_date: @agreement.start_date } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { agreement_type_id: @agreement.agreement_type_id, approved: @agreement.approved, end_date: @agreement.end_date, link: @agreement.link, start_date: @agreement.start_date } }
